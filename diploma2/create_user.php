...
if(!$current_user->is_logged_in() || !$current_user->is_admin()) {
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
        <a class="navbar-brand d-flex align-items-center fw-500" href="users.php"><img alt="logo" class="d-inline-block align-top mr-2" src="img/logo.png">
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        <?php if(Session::exists("danger")): ?>
            <div class='alert alert-danger text-dark' role='alert'><?php echo Session::flash("danger") ?></div>
        <?php endif; ?>
        <div class="subheader">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status" id="example-select">
                                        <?php foreach($current_user->get_statuses() as $key => $value): ?>
