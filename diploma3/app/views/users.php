                    ...
                    <div id="c_<?php echo $user->id; ?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $user->tags; ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php echo $user->my_status; ?> mr-3">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <?php if($current_user->isAdmin() || $current_user->is_equal($user->id)):?> 
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="status/<?php echo $user->id; ?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="photo/<?php echo $user->id; ?>">
