                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php echo $user['status']; ?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo ($user['image']) ? $user['image'] : "img/demo/avatars/avatar-m.png" ; ?>'); background-size: cover;"></span>
                                </span>
